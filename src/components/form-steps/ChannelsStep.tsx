    ...
    <div className="space-y-6">
      <Alert className="bg-brand-purple/10 border-brand-purple/20">
        ...
        <AlertDescription className="text-sm text-muted-foreground">
          Tipo detectado pela categoria principal: <strong className="text-foreground">{detectedBusinessTypeLabel}</strong>. Os diretórios abaixo são recomendados automaticamente para aumentar consistência local usando apenas diretórios de propagação. Google e Facebook ficam como fontes de dados, não como canais de propagação.
        </AlertDescription>
      </Alert>
        ...
        <CardHeader>
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <CardDescription>
                Selecionados automaticamente para {selectedBusinessTypeLabel}. Google e Facebook não aparecem aqui porque são usados como fontes de dados/identificação, não como diretórios de propagação.
              </CardDescription>
            </div>
